% legFictracEphysOpto.m
%
% Experimental Function
% For simultaneous acquisition of leg video, FicTrac, and electrophysiology
%  recording while providing optogenetic stimulation by controlling the
%  shutter in front of the mercury lamp for the scope (light through 
%  objective)
...
%       different channel
%
% CREATED: 12/17/23 - HHY
%
% UPDATED:
%  12/17/23 - HHY
%

function [rawData, inputParams, rawOutput] = legFictracEphysOpto(...
    settings, duration)
    ...
    inputParams.exptCond = 'legFictracEphysOpto'; % name of trial type
